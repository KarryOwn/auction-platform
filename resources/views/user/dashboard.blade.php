        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div class="space-y-8">
                    ...
                    {{-- Quick Links / Help --}}
                    <div class="bg-gray-900 text-white shadow-sm sm:rounded-2xl p-6 mt-4">
                        <h3 class="text-lg font-bold border-l-2 border-indigo-500 pl-3 mb-4">Need Help?</h3>
                        <ul class="space-y-3 text-sm">
                            <li><a href="#" class="text-gray-300 hover:text-white flex items-center gap-2"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> How bidding works</a></li>
