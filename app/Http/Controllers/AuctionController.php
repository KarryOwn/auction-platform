...
class AuctionController extends Controller
{
    ...
    public function liveState(Auction $auction, Request $request)
    {
        ...
        return response()->json(array_merge(
            ...
            [
                ...
                'display_price' => format_display_price((float) $auction->current_price),
                'display_currency' => display_currency(),
                'formatted_next_minimum' => format_display_price((float) $auction->minimumNextBid()),
    ...
    public function setAutoBid(Request $request, Auction $auction)
    {
        ...
        return response()->json([
            'success'    => true,
            'message'    => 'Auto-bid set up to ' . format_display_price((float) $autoBid->max_amount),
            'auto_bid'   => $autoBid,
        ]);
    }
